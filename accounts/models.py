...
class ResultTakenCourse(models.Model):
    student = models.ForeignKey(Student, on_delete=models.CASCADE, related_name="accounts_taken_courses")
    ...
    @property
    def total(self):
        return self.assignment + self.mid_exam + self.quiz + self.attendance + self.final_exam
